...
are called “pseudorandom numbers” since they are not actually truly random,
...
to know a few recipies for generating various kinds of random numbers starting
...
of $1,000.) If the investment multiplied your original moneey by a million,
...
.. activecode:: bhsawesome-random-shifted-range
   ...
   The code below generates numbers in the same range as the prevous, 0-9,
   inclusive.
