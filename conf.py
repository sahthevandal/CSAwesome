...
# new for title page
course_description = "BHS Awesome is an adaptation by Peter Seibel of CSAwesome for use at Berkeley High School. CSAwesome is a College Board endorsed curriculum for AP Computer Science A, an introductory college-level computer programming course in Java, by Barbara Ericson, University of Michigan; Beryl Hoffman, Elms College; and Peter Seibel, Berkeley High School."
...
html_logo = "_static/BHSawesomeLogo.png"
